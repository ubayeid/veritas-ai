...
if __name__ == "__main__":
    ...
    EMBEDDINGS_DIR = str(project_root / "backend" / "data_processing" / "processed" / "vector" / "standards")
    OUTPUT_DIR = str(project_root / "backend" / "building_database" / "faiss" / "standards")
