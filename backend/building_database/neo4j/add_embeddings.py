...
if __name__ == "__main__":
    ...
    with Neo4jConnection() as conn:
        ...
        # Generate new embeddings (requires OpenAI API)
            ...
            print("\nExample:")
            print("  python add_embeddings.py --json-dir backend/data_processing/processed/vector/company")
            print("  python add_embeddings.py --json-file backend/data_processing/processed/vector/standards/gdpr_embeddings.json")
